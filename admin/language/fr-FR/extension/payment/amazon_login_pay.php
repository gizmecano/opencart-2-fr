...
$_['text_guest'] = 'Invité';
$_['text_no_capture'] = '--- Pas de réception automatique ---';
...
$_['text_capture_ok_order'] = 'La réception a été réalisée avec succès : l’autorisation a été entièrement réceptionnée';
...
$_['text_column_capture_id'] = 'Identifiant de réception Amazon';
...
$_['text_amazon_signup'] = 'Souscrire à Se connecter et payer avec Amazon';
$_['text_credentials'] = 'Veuillez coller vos clefs ici (au format JSON)';
$_['text_validate_credentials'] = 'Valider et utiliser les informations d’identification';
// Columns
...
$_['entry_checkout'] = 'Mode de validation';
$_['entry_payment_region'] = 'Région de paiement';
$_['entry_capture_status'] = 'Statut de réception automatique';
...
$_['help_checkout'] = 'Si le bouton de paiement doit aussi connecter le client';
$_['help_capture_status'] = 'Choisissez le statut de la commande qui déclenchera la réception automatique d’un paiement autorisé';
...
$_['help_minimum_total'] = 'Ceci doit être au dessus de zéro';
...
$_['error_minimum_total'] = 'Le total minimum de la commande doit être au dessus de zéro';
...
$_['error_credentials'] = 'Veuillez saisir les clefs en utilisant un format JSON valide';
// Buttons
