...
$_['text_na'] = 'N/A';
$_['text_confirm_cancel'] = 'Confirmez-vous vouloir annuler cette transaction ?';
$_['text_confirm_capture'] = 'Confirmez-vous vouloir réceptionner ?';
$_['text_confirm_refund'] = 'Confirmez-vous vouloir rembourser ?';
$_['text_confirm_extend_authorization'] = 'Confirmez-vous vouloir étendre l’autorisation?';
$_['text_confirm_release_authorization'] = 'Confirmez-vous vouloir autoriser la publication de l’autorisation restante?';
$_['text_confirm_merchant_reference'] = 'Confirmez-vous vouloir mettre à jour la référence du marchand?';
$_['text_confirm_shipping_info'] = 'Confirmez-vous vouloir sauvegarder les information de livraison?';
$_['text_confirm_billing_address'] = 'Confirmez-vous vouloir mettre à jour l’adresse de facturation ?';
$_['text_confirm_shipping_address'] = 'Confirmez-vous vouloir étendre l’adresse de livraison ?';
$_['text_confirm_trigger_send_out'] = 'Confirmez-vous vouloir déclencher un nouvel envoi ?';
$_['text_confirm_settlement'] = 'Confirmez-vous vouloir traiter les fichiers de règlement?';
