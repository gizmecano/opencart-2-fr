...
$_['text_capture_payment'] = 'Paiement réceptionné';
...
$_['text_confirm_refund'] = 'Confirmez-vous vouloir rembourser le paiement ?';
$_['text_inquire_success'] = 'La demande de renseignement a réussi';
$_['text_capture_success'] = 'La requête de réception a réussi';
...
$_['help_transaction'] = 'Choisissez Paiement pour réceptionner le paiement immédiatement ou Autoriser pour avoir à l’approuver.';
...
$_['help_cron_url'] = 'Paramétrer une tâche CRON pour appeler cette URL afin que les commandes soient mises à jour automatiquement. Cette fonctionnalité est conçue pour être exécutée quelques heures après la dernière réception d’un jour ouvrable.';
...
$_['help_order_status_processing'] = 'Le statut de la commande après que la commande a été automatiquement réceptionnée.';
// Button
...
// Error
$_['error_permission'] = 'Attention : vous n’avez pas l’autorisation de modifier le module de paiement CardConnect !';
